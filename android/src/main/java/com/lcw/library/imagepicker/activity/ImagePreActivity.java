    ...
    protected void initListener() {
        ...
        mLlPreSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ConfigManager.getInstance().isSingleType()) {
                    ...
                    if (!selectPathList.isEmpty()) {
                        ...
                        if (!SelectionManager.isCanAddSelectionPaths(mMediaFileList.get(mViewPager.getCurrentItem()).getPath(), selectPathList.get(0))) {
                            //类型不同
                            Toast.makeText(com.lcw.library.imagepicker.activity.ImagePreActivity.this, getString(R.string.single_type_choose), Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                }
                ...
                if (addSuccess) {
                    ...
                    Toast.makeText(com.lcw.library.imagepicker.activity.ImagePreActivity.this, String.format(getString(R.string.select_image_max), SelectionManager.getInstance().getMaxCount()), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mIvPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = FileProvider.getUriForFile(com.lcw.library.imagepicker.activity.ImagePreActivity.this, ImagePickerProvider.getFileProviderName(com.lcw.library.imagepicker.activity.ImagePreActivity.this), new File(mMediaFileList.get(mViewPager.getCurrentItem()).getPath()));
