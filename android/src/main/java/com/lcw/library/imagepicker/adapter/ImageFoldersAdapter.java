 ...
 */
public class ImageFoldersAdapter extends RecyclerView.Adapter<com.lcw.library.imagepicker.adapter.ImageFoldersAdapter.ViewHolder> {
     ...
     * 接口回调，Item点击事件
     */
    private com.lcw.library.imagepicker.adapter.ImageFoldersAdapter.OnImageFolderChangeListener mImageFolderChangeListener;

    public void setOnImageFolderChangeListener(com.lcw.library.imagepicker.adapter.ImageFoldersAdapter.OnImageFolderChangeListener onItemClickListener) {
