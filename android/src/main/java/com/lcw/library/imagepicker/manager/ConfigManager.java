...
public class ConfigManager {
    ...
    private static volatile com.lcw.library.imagepicker.manager.ConfigManager mConfigManager;
    ...
    private String newButtonColor;
    public String getChangeButtonColor(){
        return newButtonColor;
    }

    public void setChangeButtonColor(String newButtonColor){
        this.newButtonColor = newButtonColor;
    }
    /**
     * end,
     */
    ...
    public static com.lcw.library.imagepicker.manager.ConfigManager getInstance() {
        if (mConfigManager == null) {
            synchronized (SelectionManager.class) {
                if (mConfigManager == null) {
                    mConfigManager = new com.lcw.library.imagepicker.manager.ConfigManager();
                }
            }
        }
