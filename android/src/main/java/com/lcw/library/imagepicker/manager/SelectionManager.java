...
public class SelectionManager {
    ...
    private static volatile com.lcw.library.imagepicker.manager.SelectionManager mSelectionManager;
    ...
    public static com.lcw.library.imagepicker.manager.SelectionManager getInstance() {
        if (mSelectionManager == null) {
            synchronized (com.lcw.library.imagepicker.manager.SelectionManager.class) {
                if (mSelectionManager == null) {
                    mSelectionManager = new com.lcw.library.imagepicker.manager.SelectionManager();
                }
            }
        }
