...
public class DataUtil {
    ...
    private static volatile com.lcw.library.imagepicker.utils.DataUtil mDataUtilInstance;
    private List<MediaFile> mData = new ArrayList<>();

    private DataUtil() {
    }

    public static com.lcw.library.imagepicker.utils.DataUtil getInstance() {
        if (mDataUtilInstance == null) {
            synchronized (com.lcw.library.imagepicker.utils.DataUtil.class) {
                if (mDataUtilInstance == null) {
                    mDataUtilInstance = new com.lcw.library.imagepicker.utils.DataUtil();
                }
            }
        }
