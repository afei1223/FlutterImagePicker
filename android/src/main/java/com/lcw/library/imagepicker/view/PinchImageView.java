 ...
 */
public class PinchImageView extends androidx.appcompat.widget.AppCompatImageView   //        android.support.v7.widget.AppCompatImageView
{
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == com.lcw.library.imagepicker.view.PinchImageView.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(com.lcw.library.imagepicker.view.PinchImageView pinchImageView);
    }
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(com.lcw.library.imagepicker.view.PinchImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(com.lcw.library.imagepicker.view.PinchImageView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(com.lcw.library.imagepicker.view.PinchImageView.this);
            }
            return true;
        }
    });
